...
const Page = () => {
  ...
  if (!data) return <div className="text-center mt-20">Blog not found</div>;

  // Validate image URLs
  const mainImage = data.image?.trim() || blogPlaceholder;
  const authorImage = data.authorImage?.trim() || blogPlaceholder;
